...
type xdpProgramSpecs struct {
	XdpXconnect *ebpf.ProgramSpec `ebpf:"xdp_xconnect"`
}
...
type xdpMapSpecs struct {
	XconnectMap *ebpf.MapSpec `ebpf:"xconnect_map"`
}
...
// It can be passed to loadXdpObjects or ebpf.CollectionSpec.LoadAndAssign.
type xdpMaps struct {
	XconnectMap *ebpf.Map `ebpf:"xconnect_map"`
}
...
type xdpPrograms struct {
	XdpXconnect *ebpf.Program `ebpf:"xdp_xconnect"`
}
